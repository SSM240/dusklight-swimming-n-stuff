...
Currently modding support requires an in-development build (such as [this one](https://github.com/TwilitRealm/dusklight/actions/runs/33296148438), downloads at the bottom), but hopefully that'll change at some point. No idea when though :P
